...
# $FreeBSD: tags/RELEASE_10_3_0/Tools/scripts/mark_safe.pl 358817 2014-06-22 17:53:44Z adamw $
#
...
### version
our $VERSION = do { my @r = (q$FreeBSD: tags/RELEASE_10_3_0/Tools/scripts/mark_safe.pl 358817 2014-06-22 17:53:44Z adamw $ =~ /\d+/g); sprintf "%d." . "%02d" x $#r, @r };
