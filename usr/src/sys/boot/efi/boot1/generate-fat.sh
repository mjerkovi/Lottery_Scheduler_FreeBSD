...
# $FreeBSD: releng/10.3/sys/boot/efi/boot1/generate-fat.sh 293297 2016-01-07 02:22:45Z emaste $
...
echo '# $FreeBSD: releng/10.3/sys/boot/efi/boot1/generate-fat.sh 293297 2016-01-07 02:22:45Z emaste $' >> Makefile.fat
...
echo '$FreeBSD: releng/10.3/sys/boot/efi/boot1/generate-fat.sh 293297 2016-01-07 02:22:45Z emaste $' >> $OUTPUT_FILE.bz2.uu
