 ...
 * $FreeBSD$
 * created from FreeBSD: releng/10.3/sys/kern/syscalls.master 293474 2016-01-09 14:20:23Z dchagin 
 */
...
struct gift_args {
	char t_l_[PADL_(int)]; int t; char t_r_[PADR_(int)];
	char pid_l_[PADL_(int)]; int pid; char pid_r_[PADR_(int)];
};
...
int	sys_gift(struct thread *, struct gift_args *);
